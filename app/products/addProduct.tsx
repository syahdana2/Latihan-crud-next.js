// directive 'use client' karena komponen ini berisikan state dan click event 
'use client'
import { SyntheticEvent, useState } from "react";
import { useRouter } from "next/navigation";
export default function AddProduct() {
    // digunakan untuk save atau menambahkan data pada modal
    const [title,setTitle] = useState("");
    const [price,setPrice] = useState("");
    // digunakan untuk mengendalikan modal (form) harus ditampilkan atau tidak.
    ...
    // membuat fungsi untuk event modal
                ...
                <div className="modal-box">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-control">
                            <label className="label font-label">Title</label>
                        ...
                        <div className="form-control">
                            <label className="label font-label">Price</label>
